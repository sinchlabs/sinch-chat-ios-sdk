...
internal protocol Sinch_Chat_Sdk_V1alpha2_SdkServiceClientProtocol: GRPCClient {
  ...
  func getChannels(
    _ request: Sinch_Chat_Sdk_V1alpha2_GetChannelsRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Sinch_Chat_Sdk_V1alpha2_GetChannelsRequest, Sinch_Chat_Sdk_V1alpha2_GetChannelsResponse>

  func issueRtcAccessToken(
    callOptions: CallOptions?
  ) -> ClientStreamingCall<Sinch_Chat_Sdk_V1alpha2_IssueRtcAccessTokenRequest, Sinch_Chat_Sdk_V1alpha2_IssueRtcAccessTokenResponse>

  func subscribeToChannelsStream(
    _ request: Sinch_Chat_Sdk_V1alpha2_SubscribeToChannelsStreamRequest,
    callOptions: CallOptions?,
    handler: @escaping (Sinch_Chat_Sdk_V1alpha2_SubscribeToChannelsStreamResponse) -> Void
  ) -> ServerStreamingCall<Sinch_Chat_Sdk_V1alpha2_SubscribeToChannelsStreamRequest, Sinch_Chat_Sdk_V1alpha2_SubscribeToChannelsStreamResponse>
}
...
extension Sinch_Chat_Sdk_V1alpha2_SdkServiceClientProtocol {
  ...
  internal func getChannels(
    ...
    return self.makeUnaryCall(
      path: Sinch_Chat_Sdk_V1alpha2_SdkServiceClientMetadata.Methods.getChannels.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
  ...
  /// Client streaming call to IssueRtcAccessToken
  ///
  /// Callers should use the `send` method on the returned object to send messages
  /// to the server. The caller should send an `.end` after the final message has been sent.
  ///
  ...
  ///   - callOptions: Call options.
  /// - Returns: A `ClientStreamingCall` with futures for the metadata, status and response.
  internal func issueRtcAccessToken(
    callOptions: CallOptions? = nil
  ) -> ClientStreamingCall<Sinch_Chat_Sdk_V1alpha2_IssueRtcAccessTokenRequest, Sinch_Chat_Sdk_V1alpha2_IssueRtcAccessTokenResponse> {
    return self.makeClientStreamingCall(
      path: Sinch_Chat_Sdk_V1alpha2_SdkServiceClientMetadata.Methods.issueRtcAccessToken.path,
      callOptions: callOptions ?? self.defaultCallOptions,
      interceptors: self.interceptors?.makeIssueRtcAccessTokenInterceptors() ?? []
    )
  }

  /// Server streaming call to SubscribeToChannelsStream
  ///
  /// - Parameters:
  ///   - request: Request to send to SubscribeToChannelsStream.
  ///   - callOptions: Call options.
  ///   - handler: A closure called when each response is received from the server.
  /// - Returns: A `ServerStreamingCall` with futures for the metadata and status.
  internal func subscribeToChannelsStream(
    _ request: Sinch_Chat_Sdk_V1alpha2_SubscribeToChannelsStreamRequest,
    callOptions: CallOptions? = nil,
    handler: @escaping (Sinch_Chat_Sdk_V1alpha2_SubscribeToChannelsStreamResponse) -> Void
  ) -> ServerStreamingCall<Sinch_Chat_Sdk_V1alpha2_SubscribeToChannelsStreamRequest, Sinch_Chat_Sdk_V1alpha2_SubscribeToChannelsStreamResponse> {
    return self.makeServerStreamingCall(
      path: Sinch_Chat_Sdk_V1alpha2_SdkServiceClientMetadata.Methods.subscribeToChannelsStream.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
      interceptors: self.interceptors?.makeSubscribeToChannelsStreamInterceptors() ?? [],
      handler: handler
    )
  }
}
...
internal protocol Sinch_Chat_Sdk_V1alpha2_SdkServiceAsyncClientProtocol: GRPCClient {
  ...
  func makeGetChannelsCall(
    _ request: Sinch_Chat_Sdk_V1alpha2_GetChannelsRequest,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Sinch_Chat_Sdk_V1alpha2_GetChannelsRequest, Sinch_Chat_Sdk_V1alpha2_GetChannelsResponse>

  func makeIssueRtcAccessTokenCall(
    callOptions: CallOptions?
  ) -> GRPCAsyncClientStreamingCall<Sinch_Chat_Sdk_V1alpha2_IssueRtcAccessTokenRequest, Sinch_Chat_Sdk_V1alpha2_IssueRtcAccessTokenResponse>

  func makeSubscribeToChannelsStreamCall(
    _ request: Sinch_Chat_Sdk_V1alpha2_SubscribeToChannelsStreamRequest,
    callOptions: CallOptions?
  ) -> GRPCAsyncServerStreamingCall<Sinch_Chat_Sdk_V1alpha2_SubscribeToChannelsStreamRequest, Sinch_Chat_Sdk_V1alpha2_SubscribeToChannelsStreamResponse>
}
...
extension Sinch_Chat_Sdk_V1alpha2_SdkServiceAsyncClientProtocol {
  ...
  internal func makeGetChannelsCall(
    _ request: Sinch_Chat_Sdk_V1alpha2_GetChannelsRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Sinch_Chat_Sdk_V1alpha2_GetChannelsRequest, Sinch_Chat_Sdk_V1alpha2_GetChannelsResponse> {
    return self.makeAsyncUnaryCall(
  ...
  internal func makeIssueRtcAccessTokenCall(
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncClientStreamingCall<Sinch_Chat_Sdk_V1alpha2_IssueRtcAccessTokenRequest, Sinch_Chat_Sdk_V1alpha2_IssueRtcAccessTokenResponse> {
    return self.makeAsyncClientStreamingCall(
      path: Sinch_Chat_Sdk_V1alpha2_SdkServiceClientMetadata.Methods.issueRtcAccessToken.path,
  ...
  internal func makeSubscribeToChannelsStreamCall(
    _ request: Sinch_Chat_Sdk_V1alpha2_SubscribeToChannelsStreamRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncServerStreamingCall<Sinch_Chat_Sdk_V1alpha2_SubscribeToChannelsStreamRequest, Sinch_Chat_Sdk_V1alpha2_SubscribeToChannelsStreamResponse> {
    return self.makeAsyncServerStreamingCall(
...
extension Sinch_Chat_Sdk_V1alpha2_SdkServiceAsyncClientProtocol {
  ...
  internal func getChannels(
    _ request: Sinch_Chat_Sdk_V1alpha2_GetChannelsRequest,
    callOptions: CallOptions? = nil
  ) async throws -> Sinch_Chat_Sdk_V1alpha2_GetChannelsResponse {
    return try await self.performAsyncUnaryCall(
      path: Sinch_Chat_Sdk_V1alpha2_SdkServiceClientMetadata.Methods.getChannels.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
  ...
  internal func issueRtcAccessToken<RequestStream>(
    _ requests: RequestStream,
    callOptions: CallOptions? = nil
  ) async throws -> Sinch_Chat_Sdk_V1alpha2_IssueRtcAccessTokenResponse where RequestStream: Sequence, RequestStream.Element == Sinch_Chat_Sdk_V1alpha2_IssueRtcAccessTokenRequest {
    return try await self.performAsyncClientStreamingCall(
      path: Sinch_Chat_Sdk_V1alpha2_SdkServiceClientMetadata.Methods.issueRtcAccessToken.path,
      requests: requests,
      callOptions: callOptions ?? self.defaultCallOptions,
  ...
  internal func issueRtcAccessToken<RequestStream>(
    _ requests: RequestStream,
    callOptions: CallOptions? = nil
  ) async throws -> Sinch_Chat_Sdk_V1alpha2_IssueRtcAccessTokenResponse where RequestStream: AsyncSequence & Sendable, RequestStream.Element == Sinch_Chat_Sdk_V1alpha2_IssueRtcAccessTokenRequest {
    return try await self.performAsyncClientStreamingCall(
      path: Sinch_Chat_Sdk_V1alpha2_SdkServiceClientMetadata.Methods.issueRtcAccessToken.path,
      requests: requests,
      callOptions: callOptions ?? self.defaultCallOptions,
  ...
  internal func subscribeToChannelsStream(
    _ request: Sinch_Chat_Sdk_V1alpha2_SubscribeToChannelsStreamRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncResponseStream<Sinch_Chat_Sdk_V1alpha2_SubscribeToChannelsStreamResponse> {
    return self.performAsyncServerStreamingCall(
      path: Sinch_Chat_Sdk_V1alpha2_SdkServiceClientMetadata.Methods.subscribeToChannelsStream.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
...
internal protocol Sinch_Chat_Sdk_V1alpha2_SdkServiceClientInterceptorFactoryProtocol: Sendable {
  ...
  func makeGetChannelsInterceptors() -> [ClientInterceptor<Sinch_Chat_Sdk_V1alpha2_GetChannelsRequest, Sinch_Chat_Sdk_V1alpha2_GetChannelsResponse>]

  /// - Returns: Interceptors to use when invoking 'issueRtcAccessToken'.
  func makeIssueRtcAccessTokenInterceptors() -> [ClientInterceptor<Sinch_Chat_Sdk_V1alpha2_IssueRtcAccessTokenRequest, Sinch_Chat_Sdk_V1alpha2_IssueRtcAccessTokenResponse>]

  /// - Returns: Interceptors to use when invoking 'subscribeToChannelsStream'.
  func makeSubscribeToChannelsStreamInterceptors() -> [ClientInterceptor<Sinch_Chat_Sdk_V1alpha2_SubscribeToChannelsStreamRequest, Sinch_Chat_Sdk_V1alpha2_SubscribeToChannelsStreamResponse>]
}
...
internal enum Sinch_Chat_Sdk_V1alpha2_SdkServiceClientMetadata {
  internal static let serviceDescriptor = GRPCServiceDescriptor(
    ...
    methods: [
      ...
      Sinch_Chat_Sdk_V1alpha2_SdkServiceClientMetadata.Methods.getChannels,
      Sinch_Chat_Sdk_V1alpha2_SdkServiceClientMetadata.Methods.issueRtcAccessToken,
      Sinch_Chat_Sdk_V1alpha2_SdkServiceClientMetadata.Methods.subscribeToChannelsStream,
    ]
  )
  ...
  internal enum Methods {
    ...
    internal static let getChannels = GRPCMethodDescriptor(
      name: "GetChannels",
      path: "/sinch.chat.sdk.v1alpha2.SdkService/GetChannels",
      type: GRPCCallType.unary
    )

    internal static let issueRtcAccessToken = GRPCMethodDescriptor(
      name: "IssueRtcAccessToken",
      path: "/sinch.chat.sdk.v1alpha2.SdkService/IssueRtcAccessToken",
      type: GRPCCallType.clientStreaming
    )

    internal static let subscribeToChannelsStream = GRPCMethodDescriptor(
      name: "SubscribeToChannelsStream",
      path: "/sinch.chat.sdk.v1alpha2.SdkService/SubscribeToChannelsStream",
      type: GRPCCallType.serverStreaming
    )
  }
}
...
internal final class Sinch_Chat_Sdk_V1alpha2_SdkServiceTestClient: Sinch_Chat_Sdk_V1alpha2_SdkServiceClientProtocol {
  ...
  /// Make a unary response for the GetChannels RPC. This must be called
  /// before calling 'getChannels'. See also 'FakeUnaryResponse'.
  ///
  /// - Parameter requestHandler: a handler for request parts sent by the RPC.
  internal func makeGetChannelsResponseStream(
    _ requestHandler: @escaping (FakeRequestPart<Sinch_Chat_Sdk_V1alpha2_GetChannelsRequest>) -> () = { _ in }
  ) -> FakeUnaryResponse<Sinch_Chat_Sdk_V1alpha2_GetChannelsRequest, Sinch_Chat_Sdk_V1alpha2_GetChannelsResponse> {
    return self.fakeChannel.makeFakeUnaryResponse(path: Sinch_Chat_Sdk_V1alpha2_SdkServiceClientMetadata.Methods.getChannels.path, requestHandler: requestHandler)
  }

  internal func enqueueGetChannelsResponse(
    _ response: Sinch_Chat_Sdk_V1alpha2_GetChannelsResponse,
    _ requestHandler: @escaping (FakeRequestPart<Sinch_Chat_Sdk_V1alpha2_GetChannelsRequest>) -> () = { _ in }
  ) {
    let stream = self.makeGetChannelsResponseStream(requestHandler)
    // This is the only operation on the stream; try! is fine.
    try! stream.sendMessage(response)
  }

  /// Returns true if there are response streams enqueued for 'GetChannels'
  internal var hasGetChannelsResponsesRemaining: Bool {
    return self.fakeChannel.hasFakeResponseEnqueued(forPath: Sinch_Chat_Sdk_V1alpha2_SdkServiceClientMetadata.Methods.getChannels.path)
  }

  /// Make a unary response for the IssueRtcAccessToken RPC. This must be called
  /// before calling 'issueRtcAccessToken'. See also 'FakeUnaryResponse'.
  ///
  /// - Parameter requestHandler: a handler for request parts sent by the RPC.
  internal func makeIssueRtcAccessTokenResponseStream(
    _ requestHandler: @escaping (FakeRequestPart<Sinch_Chat_Sdk_V1alpha2_IssueRtcAccessTokenRequest>) -> () = { _ in }
  ) -> FakeUnaryResponse<Sinch_Chat_Sdk_V1alpha2_IssueRtcAccessTokenRequest, Sinch_Chat_Sdk_V1alpha2_IssueRtcAccessTokenResponse> {
    return self.fakeChannel.makeFakeUnaryResponse(path: Sinch_Chat_Sdk_V1alpha2_SdkServiceClientMetadata.Methods.issueRtcAccessToken.path, requestHandler: requestHandler)
  }

  internal func enqueueIssueRtcAccessTokenResponse(
    _ response: Sinch_Chat_Sdk_V1alpha2_IssueRtcAccessTokenResponse,
    _ requestHandler: @escaping (FakeRequestPart<Sinch_Chat_Sdk_V1alpha2_IssueRtcAccessTokenRequest>) -> () = { _ in }
  ) {
    let stream = self.makeIssueRtcAccessTokenResponseStream(requestHandler)
    // This is the only operation on the stream; try! is fine.
    try! stream.sendMessage(response)
  }

  /// Returns true if there are response streams enqueued for 'IssueRtcAccessToken'
  internal var hasIssueRtcAccessTokenResponsesRemaining: Bool {
    return self.fakeChannel.hasFakeResponseEnqueued(forPath: Sinch_Chat_Sdk_V1alpha2_SdkServiceClientMetadata.Methods.issueRtcAccessToken.path)
  }

  /// Make a streaming response for the SubscribeToChannelsStream RPC. This must be called
  /// before calling 'subscribeToChannelsStream'. See also 'FakeStreamingResponse'.
  ///
  /// - Parameter requestHandler: a handler for request parts sent by the RPC.
  internal func makeSubscribeToChannelsStreamResponseStream(
    _ requestHandler: @escaping (FakeRequestPart<Sinch_Chat_Sdk_V1alpha2_SubscribeToChannelsStreamRequest>) -> () = { _ in }
  ) -> FakeStreamingResponse<Sinch_Chat_Sdk_V1alpha2_SubscribeToChannelsStreamRequest, Sinch_Chat_Sdk_V1alpha2_SubscribeToChannelsStreamResponse> {
    return self.fakeChannel.makeFakeStreamingResponse(path: Sinch_Chat_Sdk_V1alpha2_SdkServiceClientMetadata.Methods.subscribeToChannelsStream.path, requestHandler: requestHandler)
  }

  internal func enqueueSubscribeToChannelsStreamResponses(
    _ responses: [Sinch_Chat_Sdk_V1alpha2_SubscribeToChannelsStreamResponse],
    _ requestHandler: @escaping (FakeRequestPart<Sinch_Chat_Sdk_V1alpha2_SubscribeToChannelsStreamRequest>) -> () = { _ in }
  ) {
    let stream = self.makeSubscribeToChannelsStreamResponseStream(requestHandler)
    // These are the only operation on the stream; try! is fine.
    responses.forEach { try! stream.sendMessage($0) }
    try! stream.sendEnd()
  }

  /// Returns true if there are response streams enqueued for 'SubscribeToChannelsStream'
  internal var hasSubscribeToChannelsStreamResponsesRemaining: Bool {
    return self.fakeChannel.hasFakeResponseEnqueued(forPath: Sinch_Chat_Sdk_V1alpha2_SdkServiceClientMetadata.Methods.subscribeToChannelsStream.path)
  }
}
