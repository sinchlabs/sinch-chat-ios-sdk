...
// Source: sinch/conversationapi/type/opt_out.proto
//
...
/// on a given channel.
struct Sinch_Conversationapi_Type_OptOut {
  ...
  /// Optional.
  /// Provides the ability to change the default processing strategy and not create a contact during opt-out. 
...
extension Sinch_Conversationapi_Type_OptOut: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".OptOut"
  ...
  static func ==(lhs: Sinch_Conversationapi_Type_OptOut, rhs: Sinch_Conversationapi_Type_OptOut) -> Bool {
