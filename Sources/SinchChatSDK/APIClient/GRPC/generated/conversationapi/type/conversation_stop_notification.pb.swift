...
// Source: sinch/conversationapi/type/conversation_stop_notification.proto
//
...
struct Sinch_Conversationapi_Type_ConversationStopNotification {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Required. The stopped conversation.
...
extension Sinch_Conversationapi_Type_ConversationStopNotification: @unchecked Sendable {}
...
extension Sinch_Conversationapi_Type_ConversationStopNotification: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ConversationStopNotification"
  ...
  static func ==(lhs: Sinch_Conversationapi_Type_ConversationStopNotification, rhs: Sinch_Conversationapi_Type_ConversationStopNotification) -> Bool {
