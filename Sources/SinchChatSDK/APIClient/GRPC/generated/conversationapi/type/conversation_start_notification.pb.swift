...
// Source: sinch/conversationapi/type/conversation_start_notification.proto
//
...
struct Sinch_Conversationapi_Type_ConversationStartNotification {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Required. The started conversation.
...
extension Sinch_Conversationapi_Type_ConversationStartNotification: @unchecked Sendable {}
...
extension Sinch_Conversationapi_Type_ConversationStartNotification: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ConversationStartNotification"
  ...
  static func ==(lhs: Sinch_Conversationapi_Type_ConversationStartNotification, rhs: Sinch_Conversationapi_Type_ConversationStartNotification) -> Bool {
