...
struct Sinch_Conversationapi_Adapter_V1beta_GetUserProfileRequest {
  ...
  /// Channel identity for which to perform user profile fetch.
  var channelIdentity: String = String()

  ///Field used to identify requests in the service's logs.
...
struct Sinch_Conversationapi_Adapter_V1beta_GetUserProfileResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// Optional. A reason shall be present if the user profile check failed.
...
extension Sinch_Conversationapi_Adapter_V1beta_GetUserProfileRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Sinch_Conversationapi_Adapter_V1beta_GetUserProfileRequest, rhs: Sinch_Conversationapi_Adapter_V1beta_GetUserProfileRequest) -> Bool {
...
extension Sinch_Conversationapi_Adapter_V1beta_GetUserProfileResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Sinch_Conversationapi_Adapter_V1beta_GetUserProfileResponse, rhs: Sinch_Conversationapi_Adapter_V1beta_GetUserProfileResponse) -> Bool {
